...
import { SelectView, type ServerOptionId } from '@/pages/Setup/SelectView'
import { LocalServerView } from '@/pages/Setup/LocalServerView'
import { RemoteServerView } from '@/pages/Setup/RemoteServerView'
import { ConnectingView } from '@/pages/Setup/ConnectingView'
import { ConnectionSuccessView } from '@/pages/Setup/ConnectionSuccessView'
import { ConnectionFailedView } from '@/pages/Setup/ConnectionFailedView'
import { SetupCompleteView } from '@/pages/Setup/SetupCompleteView'
